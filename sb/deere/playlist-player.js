/*! For license information please see staffbase.playlist-player.js.LICENSE.txt */
!(function () {
  "use strict";
  var e = {
      287: function (e, n) {
      ...
      551: function (e, n, t) {
        ...
        function ba(e) {
          ...
          function s(e, n, t, r) {
            ...
            return a === E
              ...
              : (((r = Ds(t.type, t.key, t.props, null, e.mode, r)).ref = ga(
                  e,
                  n,
                  t
                )),
          ...
          function d(e, n, t) {
            ...
            if ("object" == typeof n && null !== n) {
              switch (n.$$typeof) {
                case k:
                  return (
                    ((t = Ds(n.type, n.key, n.props, null, e.mode, t)).ref = ga(
                      e,
                      null,
                      n
                    )),
        ...
        function Ya(e, n) {
          switch ((_l(qa, n), _l(Wa, e), _l(Qa, Ha), (e = n.nodeType))) {
            case 9:
            case 11:
        ...
        function Ho(e, n, t) {
          return 21 & ao
            ? (ur(t, n) ||
                ((t = gn()), (oo.lanes |= t), (Ii |= t), (e.baseState = !0)),
              n)
        ...
        function Nu(e, n, t, r, l, a) {
          Cu(e, n);
          var o = !!(128 & n.flags);
          if (!r && !o) return l && Fl(n, t, !1), Hu(e, n, a);
              ...
              if (((i = !!(u & e.childLanes)), bu || i)) {
                if (null !== (r = zi)) {
                  ...
                  0 !== (l = l & (r.suspendedLanes | u) ? 0 : l) &&
                    l !== o.retryLane &&
                    ((o.retryLane = l), Da(e, l), ts(r, e, l, -1));
                }
        ...
        function $u(e, n, t) {
          var r = n.pendingProps,
            l = r.revealOrder,
            a = r.tail;
          if ((wu(e, n, r.children, t), 2 & (r = Ja.current)))
            (r = (1 & r) | 2), (n.flags |= 128);
          else {
        ...
        function qu(e, n, t) {
          ...
          switch ((na(n), n.tag)) {
            ...
            case 19:
              if ((Cl(Ja), null === (o = n.memoizedState))) return Wu(n), null;
        ...
        Ei = function (e, n, t) {
          ...
          else (bu = !1), la && 1048576 & n.flags && Jl(n, Wl, n.index);
        ...
        (Ys.prototype.render = Ks.prototype.render =
          ...
          (En = function (e) {
            if (13 === e.tag) {
              ...
              null !== n && ts(n, e, 134217728, es()), Ws(e, 134217728);
            }
          }),
          (xn = function (e) {
            if (13 === e.tag) {
      ...
      v = (e) => {
        ...
        (t.src = e.url),
          ...
          document
            ...
            .forEach((e) => {
              e.href.endsWith(".mp3") &&
                (Object.keys(n).includes(e.href) ||
                  (n[e.href] = e.textContent
                    .replace(".mp3", "")
                    .replace("_", " ")));
            }),
          console.log("Found audio tracks: ", n),
          (i.current.innerHTML = '"' + e.title + '"'),
    ...
    return (
      ...
      (0, r.useEffect)(async () => {
        if (n)
          (u.current.src = n),
            ...
            document.querySelector("html")?.dataset.postId;
        else {
          await (function (e) {
            let n =
      ...
      r.createElement(
        ...
        r.createElement(
          "div",
          {
            ...
            onClick: (e) => {
              if (u.current && s.current) {
                ...
                (u.current.currentTime = t), m((t / u.current.duration) * 100);
              }
            },
            style: {
              position: "relative",
          ...
          r.createElement("div", {
            style: { height: "100%", width: `${p}%`, background: "#00b0b0" },
          })
        ),
        r.createElement(
          "div",
          ...
          r.createElement(
            ...
            r.createElement(
              "svg",
              {
                ...
                class: "feather feather-play-pause",
              },
          ...
          r.createElement(
            ...
            r.createElement(
              "svg",
              {
                ...
                "stroke-linecap": "round",
                "stroke-linejoin": "round",
                class: "feather feather-play-faster",
              },
              r.createElement("polygon", { points: "3 20 12 12 3 4 3 20" }),
              r.createElement("polygon", { points: "11 20 20 12 11 4 11 20" }),
              r.createElement("line", { x1: "22", y1: "4", x2: "22", y2: "20" })
            )
          ),
          r.createElement(
            "button",
            ...
            r.createElement(
              "svg",
              {
                ...
                "stroke-linecap": "round",
                "stroke-linejoin": "round",
                class: "feather feather-play-slower",
              },
              r.createElement("polygon", { points: "21 4 12 12 21 20 21 4" }),
              r.createElement("polygon", { points: "13 4 4 12 13 20 13 4" }),
              r.createElement("line", { x1: "2", y1: "4", x2: "2", y2: "20" })
            )
          )
        ),
        r.createElement(
          ...
          r.createElement(
            "button",
            { onClick: () => {}, ref: d, title: "Previous track" },
            r.createElement(
              "svg",
              {
                xmlns: "http://www.w3.org/2000/svg",
              ...
              r.createElement("line", { x1: "5", y1: "5", x2: "5", y2: "19" })
            )
          ),
          r.createElement(
            "button",
  ...
  const c = ["url"],
    f = {
      ...
      uiSchema: {
        url: { "ui:help": "The URL of the audio file to be played." },
      },
